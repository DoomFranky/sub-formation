package hei.school.inscription.endpoint.event.consumer;

import hei.school.inscription.PojaGenerated;
import hei.school.inscription.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.inscription.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.inscription.service.event."
