...
import static hei.school.inscription.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.inscription.PojaGenerated;
import hei.school.inscription.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "hei.school.inscription.event1";
  }
}
