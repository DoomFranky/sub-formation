package hei.school.inscription.handler;

import static hei.school.inscription.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.inscription.PojaApplication;
import hei.school.inscription.PojaGenerated;
import hei.school.inscription.endpoint.EndpointConf;
import hei.school.inscription.endpoint.event.EventConf;
import hei.school.inscription.endpoint.event.consumer.EventConsumer;
import hei.school.inscription.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.inscription.endpoint.event.consumer.model.ConsumableEventTyper;
