...
import static hei.school.inscription.endpoint.rest.controller.health.PingController.KO;
import static hei.school.inscription.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.inscription.PojaGenerated;
import hei.school.inscription.endpoint.event.EventProducer;
import hei.school.inscription.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.inscription.endpoint.event.model.UuidCreated;
import hei.school.inscription.repository.DummyUuidRepository;
import hei.school.inscription.repository.model.DummyUuid;
